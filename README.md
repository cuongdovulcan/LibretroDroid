...
dependencies {
    ...
    implementation 'com.github.cuongdovulcan:LibretroDroid:<version>'
    ...
}
```

Note: Replace `<version>` with the release tag (e.g., `1.2.1`) or use `-SNAPSHOT` for the latest commit.
